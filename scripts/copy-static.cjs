...
for (const file of ['index.html', 'styles.css', 'float.html', 'float.css', 'float.js', 'public-network-warning.html', 'public-network-warning.css', 'public-network-warning.js']) {
